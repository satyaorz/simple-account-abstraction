...
contract ZkMinimalAccountTest is Test {
    ...
    function setUp() public {
        ...
        minimalAccount.transferOwnership(ANVIL_DEFUALT_ACCOUNT);
        usdc = new ERC20Mock();
        vm.deal(address(minimalAccount), AMOUNT);
    }

    function testZkOwnerCanExecuteCommads() public {
        // Arrange
    ...
    function _createUnsignedTransaction(
        ...
        return Transaction({
            ...
            to: uint256(uint160(to)), // this is how we convert an address from type addrss to type uin256, address -> uin160 -> uint256
            gasLimit: 16777216,
